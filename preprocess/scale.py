...
if __name__ == "__main__":
    image_dir = r"/usr/users/sdim/sdim_31/UX-Key-PFE/dataset/vae_dataset_phone/train"
    output_dir = r"/usr/users/sdim/sdim_31/UX-Key-PFE//dataset/vae_dataset_phone/train_scaled"
