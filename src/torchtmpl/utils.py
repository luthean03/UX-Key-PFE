...
def set_reproducibility(seed: int) -> None:
    ...
    # Allow cuDNN to auto-tune convolution algorithms for speed.
    # NOTE: set both to True only when input sizes don't vary much
    # (SmartBatchSampler groups similar heights, so this is safe).
